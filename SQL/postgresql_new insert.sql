...
-- Pictures
INSERT INTO pictures(description,category_id,path) VALUES ('Prendre le bus',5,'bus');
INSERT INTO pictures(description,category_id,path) VALUES ('Marcher',5,'marcher');
INSERT INTO pictures(description,category_id,path) VALUES ('Traverser un passage piéton',5,'traverser');
INSERT INTO pictures(description,category_id,path) VALUES ('Faire du vélo',5,'velo');
INSERT INTO pictures(description,category_id,path) VALUES ('Etre dans la voiture',5,'voiture');
INSERT INTO pictures(description,category_id,path) VALUES ('Avoir son casque et son ordinateur',7,'casque_ordi'); 
INSERT INTO pictures(description,category_id,path) VALUES ('Ecrire',7,'ecrire');
INSERT INTO pictures(description,category_id,path) VALUES ('Lire',7,'lire');
INSERT INTO pictures(description,category_id,path) VALUES ('Regarder la télévision',7,'television');
INSERT INTO pictures(description,category_id,path) VALUES ('Allumer la lumière', 4, 'allumer_lumiere'); 
INSERT INTO pictures(description,category_id,path) VALUES ('Balayer', 4, 'balayer');
INSERT INTO pictures(description,category_id,path) VALUES ('Utiliser la machine à laver', 4, 'machine_laver');
INSERT INTO pictures(description,category_id,path) VALUES ('Passer d´une pièce à l´autre', 4, 'passer_piece');
INSERT INTO pictures(description,category_id,path) VALUES ('Avoir une prothèse', 4, 'prothese'); 
INSERT INTO pictures(description,category_id,path) VALUES ('Ranger son espace', 4, 'ranger_espace');
INSERT INTO pictures(description,category_id,path) VALUES ('Faire la vaisselle', 4, 'vaisselle');
INSERT INTO pictures(description,category_id,path) VALUES ('Boire avec une tasse', 1,'boire_tasse');
INSERT INTO pictures(description,category_id,path) VALUES ('Dresser la table', 1,'dresser_table');
INSERT INTO pictures(description,category_id,path) VALUES ('Manger au restaurant', 1,'manger_restaurant');
INSERT INTO pictures(description,category_id,path) VALUES ('Manger avec les mains', 1,'manger_mains');
INSERT INTO pictures(description,category_id,path) VALUES ('Préparer à manger', 1,'preparer_manger');
INSERT INTO pictures(description,category_id,path) VALUES ('Manger un sandwich', 1,'sandwich');
INSERT INTO pictures(description,category_id,path) VALUES ('Servir des aliments', 1,'servir_aliments');
INSERT INTO pictures(description,category_id,path) VALUES ('Parler à des adultes',3,'parler_adultes');
INSERT INTO pictures(description,category_id,path) VALUES ('Parler en communauté',3,'parler_communaute');
INSERT INTO pictures(description,category_id,path) VALUES ('Parler au téléphone',3,'telephone');
INSERT INTO pictures(description,category_id,path) VALUES ('Acheter quelque chose',6,'acheter ');
INSERT INTO pictures(description,category_id,path) VALUES ('Se laver les mains',2,'laver_mains');
INSERT INTO pictures(description,category_id,path) VALUES ('Aller aux urgences',2,'urgence');
INSERT INTO pictures(description,category_id,path) VALUES ('Se brosser les cheveux',2,'brosser_cheveux');
INSERT INTO pictures(description,category_id,path) VALUES ('Mettre ses chaussures',2,'chaussures');
INSERT INTO pictures(description,category_id,path) VALUES ('Dormir',2,'dormir');
INSERT INTO pictures(description,category_id,path) VALUES ('Prendre une douche',2,'douche');
INSERT INTO pictures(description,category_id,path) VALUES ('Mettre des habits sales',2,'habits_sales');
INSERT INTO pictures(description,category_id,path) VALUES ('Se laver les cheveux',2,'laver_cheveux');
INSERT INTO pictures(description,category_id,path) VALUES ('Choisir ses vêtements',2,'vetements_garderobe');
INSERT INTO pictures(description,category_id,path) VALUES ('Se brosser les dents',2,'brosser_dents');
INSERT INTO pictures(description,category_id,path) VALUES ('Se lever',2,'lever');
INSERT INTO pictures(description,category_id,path) VALUES ('Se moucher',2,'moucher');
INSERT INTO pictures(description,category_id,path) VALUES ('Se sécher les cheveux',2,'secher_cheveux');
INSERT INTO pictures(description,category_id,path) VALUES ('S´essuyer',2,'essuyer');
INSERT INTO pictures(description,category_id,path) VALUES ('S´habiller',2,'habiller');
INSERT INTO pictures(description,category_id,path) VALUES ('Mettre des habits avec une tirette',2,'habiller_tirette');
INSERT INTO pictures(description,category_id,path) VALUES ('Aller aux toilettes',2,'toilettes');
-- Children
